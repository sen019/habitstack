import svgPaths from "./svg-1baqr63k1o";
    ...
    <div className="bg-[#ececec] relative rounded-[8px] shrink-0 w-full" data-name="input-field">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[4px] items-center p-[16px] relative w-full">
          <p className="font-['Geist:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] text-gray-900 w-[460px]">{`You failed to do it. Better delete it before anyone sees!"`}</p>
        </div>
      </div>
    </div>
  );
