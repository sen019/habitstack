import svgPaths from "./svg-8jmuzp8yyt";
...
function CardHeader() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="card-header">
      <p className="font-['Geist:SemiBold',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] text-gray-900 text-nowrap whitespace-pre">Reset this habit</p>
      <Buttons />
    </div>
  );
}
    ...
    <div className="bg-[#ececec] relative rounded-[8px] shrink-0 w-full" data-name="input-field">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[4px] items-center p-[16px] relative w-full">
          <p className="font-['Geist:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] text-gray-900 w-[460px]">Would you like to reset this habit and start over again?</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-gray-50 h-[58px] relative rounded-[8px] shrink-0 w-full" data-name="submit-button">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[8px] h-[58px] items-center justify-center px-[24px] py-[12px] relative w-full">
          <p className="font-['Geist:SemiBold',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#db2a19] text-[18px] text-nowrap whitespace-pre">Reset Habit</p>
        </div>
      </div>
...
function Menu() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="menu">
      <InputField />
      <SubmitButton />
      <p className="font-['Geist:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#db2a19] text-[16px] text-nowrap whitespace-pre">This action is irreversible and will permanently reset the habit.</p>
    </div>
  );
}
...
function Modal() {
  return (
    <div className="bg-gray-50 box-border content-stretch flex flex-col gap-[24px] items-start p-[24px] relative rounded-[8px] shrink-0 w-[600px] z-[1]" data-name="modal">
...
function Modal1() {
  return (
    <div className="absolute backdrop-blur-sm backdrop-filter bg-[rgba(98,104,126,0.1)] content-stretch flex h-[832px] isolate items-center justify-center left-0 overflow-clip top-1/2 translate-y-[-50%] w-[1280px] z-[4]" data-name="modal">
      <Modal />
    </div>
  );
}
...
function DateButton1() {
  return (
    <div className="bg-gray-50 box-border content-stretch flex gap-[8px] h-full items-center justify-center p-[12px] relative rounded-[4px] shrink-0" data-name="date-button">
      <p className="font-['Inter:Bold',_sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[16px] text-gray-900 text-nowrap whitespace-pre">Mon 22</p>
    </div>
  );
}
...
function HabitCardHeader() {
  return (
    <div className="bg-[#ececec] relative rounded-[4px] shrink-0 w-full" data-name="habit-card-header">
      <div className="flex flex-row items-center size-full">
...
function HabitProgressGraph() {
  return (
    <div className="bg-gray-50 relative rounded-[4px] shrink-0 w-full" data-name="habit-progress-graph">
...
function Card() {
  return (
    <div className="bg-gray-50 relative rounded-[8px] shrink-0 w-full z-[1]" data-name="card">
      <div aria-hidden="true" className="absolute border-2 border-gray-900 border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.2)]" />
      <div className="size-full">
...
function HabitCard() {
  return (
    <div className="bg-gray-50 box-border content-stretch flex flex-col gap-[12px] isolate items-start p-[6px] relative rounded-[14px] shrink-0 w-[606px]" data-name="habit-card">
      <Card />
  ...
  return (
    <div className="basis-0 bg-gray-50 grow min-h-px min-w-px relative shrink-0 w-full z-[1]" data-name="habit-listing">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-start flex flex-wrap gap-[20px] items-start p-[24px] relative size-full">
