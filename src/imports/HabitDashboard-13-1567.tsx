import svgPaths from "./svg-4lvro874pi";

function DropdownOption() {
  return (
    <div className="bg-gray-50 relative rounded-[8px] shrink-0 w-full" data-name="dropdown-option">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative w-full">
          <p className="font-['Geist:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-gray-900 text-nowrap whitespace-pre">Reset</p>
        </div>
      </div>
    </div>
  );
...
function DropdownOption1() {
  return (
    <div className="bg-gray-50 relative rounded-[8px] shrink-0 w-full" data-name="dropdown-option">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative w-full">
          <p className="font-['Geist:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-gray-900 text-nowrap whitespace-pre">Rename</p>
        </div>
      </div>
    </div>
  );
...
function DropdownOption2() {
  return (
    <div className="bg-gray-50 relative rounded-[8px] shrink-0 w-full" data-name="dropdown-option">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative w-full">
          <p className="font-['Geist:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#db2a19] text-[16px] text-nowrap whitespace-pre">Delete</p>
        </div>
      </div>
    </div>
  );
...
function IconsDropdown() {
  return (
    <div className="bg-gray-50 box-border content-stretch flex flex-col gap-[4px] items-start p-[4px] relative rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-[440px] z-[1]" data-name="icons/dropdown">
      <div aria-hidden="true" className="absolute border border-gray-900 border-solid inset-0 pointer-events-none rounded-tl-[12px] rounded-tr-[12px] shadow-[0px_3px_6px_100px_rgba(0,0,0,0.2)]" />
      <DropdownOption />
      <DropdownOption1 />
      <DropdownOption2 />
    </div>
...
function Modal() {
  return (
    <div className="absolute backdrop-blur-sm backdrop-filter bg-[rgba(98,104,126,0.1)] content-stretch flex h-[832px] isolate items-end justify-center left-0 overflow-clip top-1/2 translate-y-[-50%] w-[440px] z-[4]" data-name="modal">
      <IconsDropdown />
    </div>
  );
}
