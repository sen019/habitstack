import svgPaths from "./svg-v62cv22asy";
    ...
    <div className="basis-0 bg-gray-50 grow h-full min-h-px min-w-px relative rounded-[4px] shrink-0" data-name="date-button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[8px] items-center justify-center p-[12px] relative size-full">
          <p className="font-['Inter:Bold',_sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#009463] text-[16px] text-nowrap whitespace-pre">Mon 22</p>
        </div>
      </div>
    </div>
  );
...
function StreakCount() {
  return (
    <div className="bg-gray-50 box-border content-stretch flex gap-[8px] items-center justify-center p-[8px] relative rounded-[20px] shrink-0 size-[40px]" data-name="streak-count">
...
function Buttons5() {
  return (
    <div className="bg-gray-50 box-border content-stretch flex gap-[8px] items-center overflow-clip px-[20px] py-[8px] relative rounded-[4px] shrink-0" data-name="buttons">
      <Icons5 />
    </div>
  );
}
...
function HabitCard() {
  return (
    <div className="bg-gray-50 box-border content-stretch flex flex-col gap-[12px] isolate items-start p-[12px] relative rounded-[8px] shrink-0 w-[606px]" data-name="habit-card">
      <div aria-hidden="true" className="absolute border-2 border-gray-900 border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_3px_6px_100px_rgba(0,0,0,0.2)]" />
      <HabitCardHeader />
      <HabitProgressGraph />
    </div>
  );
